    ...
    <section>
      <div className="relative" id="home">
        ...
        >
          ...
          <div className="to-sky-300 h-32 bg-gradient-to-r from-red-400 blur-[106px] dark:to-indigo-600"></div>
        </div>
        <div className="container mx-auto">
          <div className="relative ml-auto pt-36">
            ...
            <div className="mt-16 hidden justify-between gap-5 border-y border-gray-100 py-8 dark:border-gray-800 sm:flex">
              <div className="text-left">
                <h6 className="text-lg font-semibold text-gray-700 dark:text-white">Buy New Car</h6>
              ...
              <div className="text-left">
                <h6 className="text-lg font-semibold text-gray-700 dark:text-white">Buy Used Car</h6>
                <p className="mt-2 text-gray-500">
      ...
      <div className="relative py-16">
        ...
        >
          <div className="from-primary h-56 bg-gradient-to-br to-purple-400 blur-[106px] dark:from-blue-700"></div>
          <div className="to-sky-300 h-32 bg-gradient-to-r from-cyan-400 blur-[106px] dark:to-indigo-600"></div>
        </div>
        <div className="container mx-auto">
